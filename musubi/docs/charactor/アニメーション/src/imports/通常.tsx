...
export default function Component() {
  return (
    <div className="relative size-full" data-name="通常">
      <svg className="absolute block size-full overflow-visible" fill="none" preserveAspectRatio="xMidYMid meet" viewBox="0 0 700 800">
        <g id="éå¸¸">
          ...
          <path className="anim-inner-ahoge" style={{ transformOrigin: "350px 480px" }} d={svgPaths.pe960bc0} fill="var(--fill-0, #F3F1EC)" id="ã¢ãæ¯" stroke="var(--stroke-0, #4E3A3A)" strokeWidth="3" />
          <g className="anim-inner-body" style={{ transformOrigin: "350px 700px" }}>
            ...
            <path d={svgPaths.p14bf700} fill="var(--fill-0, #FF1717)" id="å·¦éå" />
            <path d={svgPaths.p311bc880} fill="var(--fill-0, #FF1717)" id="å³éå" />
