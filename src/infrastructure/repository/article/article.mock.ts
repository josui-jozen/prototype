...
const bodies = [
  'テストの本文です。しずかなインターネットは、日記やエッセイを書くのにちょうどいい、文章書き散らしサービスです。',
  'もう一つのテスト記事です。',
  'しずかなインターネットを運営しているcatnoseという者です。しずかなインターネットをお探しの方はこちらのリンクからアクセスしてもらえると嬉しいです。\n\n## 経緯\n\n2024年9月からsizu.me内の「しずかなインターネット」というキーワードをタイトルに含むページが検索結果から突然消えました。',
]
