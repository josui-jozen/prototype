export default {
  ...
  // Values
  "values.heading": "這款編輯器的追求",
  "values.body": "這款編輯器致力於成為使用者的「可攜帶的書房」。書房是一個始終在那裡、迎接你的地方——可以說是心靈的棲息之所。為了成為這樣的存在，我們以書房的功能為比喻，定義了這款編輯器應有的功能。",
  "values.door.title": "門",
  "values.door.ruby": "",
  "values.door.description": "與外界噪音隔絕",
  "values.door.feature1": "去除多餘的極簡UI",
  "values.brush.title": "筆",
  "values.brush.ruby": "",
  "values.brush.description": "可按喜好自由調整",
  "values.brush.feature1": "字體與排版自訂功能",
  "values.bookmark.title": "書籤",
  "values.bookmark.ruby": "",
  "values.bookmark.description": "始終以不變的狀態迎接你",
  "values.bookmark.feature1": "PC與手機同步工作環境",
  "values.bookmark.feature2": "離線工作",
  "values.shelf.title": "書架",
  "values.shelf.ruby": "",
  "values.shelf.description": "可積累與活用過去的資訊",
  "values.shelf.feature1": "與AI代理協同寫作",
