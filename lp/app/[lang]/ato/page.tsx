...
import TypedSectionTitle from './components/TypedSectionTitle'
import './page.css'
...
import { segments as segByNumber } from './assets/essay/segments'
const segSrc = (n: number) => segByNumber[n]
...
export default function AtoPage() {
  return (
    <LpShell className="ato" role="main">
      <SoundPlayer />
      <section className="ato-fv">
        <video
          className="ato-bg-video"
          src="/ato/bg/iStock-2267331151-HD.mov"
          loop
          muted
          playsInline
        />
